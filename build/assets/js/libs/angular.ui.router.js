// https://github.com/dlukez/ui-router angular-1.2 branch

/**
 * State-based routing for AngularJS
 * @version v0.2.0-dev-2013-10-19
        ...
        function updateView(doAnimate) {
          ...
          if(locals && locals.$template) {
            ...
            linker(newScope, function(clone) {
              ...
              clone.html(locals.$template);
              render.enter(clone, element);

              clone.data('$uiView', view);
            ...
            // render.enter(currentElement, element);
            console.log('SUPP');
